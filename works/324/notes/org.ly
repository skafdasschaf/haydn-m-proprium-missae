...
CCCXXIVOrgano = {
  \relative c {
    ...
    e-\solo g fis h, r h' e e,
    r g fis h, r dis' e h
    g a h h, e4-\tutti r8 e
    ...
    e e fis fis, g g a a
    h h h h e4 r
    r8 e-\solo c'16 h a g fis8 fis fis fis
    d d d d g4 r
    ...
    a'4 r8 a, d d c! c
    h h c c h h h h
    e4 r r8 e'16-\unisono d cis h ais gis
    fis8 cis'16 h ais gis fis e d8 h' e, fis
    h h\p h h a a a a %90
    ...
    r h' a d, r d g e %135
    c r d r g4 r
    g8-\unisono d h d g4 r\fermata \bar "|." %137 finis
  }
}

CCCXXIVBassFigures = \figuremode {
