...
DCCCAlto = {
  \relative c' {
    ...
    a a a2
    fis r %170
    R1\fermata \bar "|." %171 finis
  }
}

DCCCAltoLyrics = \lyricmode {
  Te, te
  De -- um lau --
  da -- mus, te
  Do -- mi -- num con -- fi --
...
DCCCcAlto = {
  \relative c' {
    ...
    R1
    r4 \mvTr h'\f^\tuttiE h d, %180
    r cis cis fis
    fis2 r4 fis
    g2 e
    e4 d r g
    g g8 g cis,4. fis8 %185
    fis4 fis r2
    fis fis4 h
    g4. g8 g2
    fis4 fis fis4. fis8
    ...
    r cis2 fis4
    fis fis r fis %240
    g8([ fis)] g([ fis)] e4 e8 e
    e4 d r2
    g8([ fis)] g fis e4 e
    e( d) r2
    fis4. fis8 fis4 fis %245
    fis2 r4 fis
    fis4. fis8 fis4 fis
    e4. e8 e4 e
    a4. fis8 fis4 fis
