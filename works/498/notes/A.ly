...
CDXCVIIIAltoNotes = {
  \relative c' {
    ...
    R1*4
    \mvTr f8.\fE^\tutti f16 f8 f f f r f %5
    f2 f4 r8 f
    f2 es4 r8 g
    g4 g f8. f16 f8 d
    f c' \appoggiatura c b4 a r8 c,
    d f f([ d)] c4 r8 a' %10
    b c d([ b)] a4 r8 f
    f4 f f f8 f
    f f r a g4 b8([ a)]
    ...
    g4 g g c,8 c
    c2 b4 r
    r8 es g g r g g f %45
    r f f f f8. c'16 b8([ g)]
    d f f4 f r
    f8. f16 f8 f b f r f
    f4 f f8 f r4
    f8. f16 f8 f b f r f %50
    f4 f f8. f16 f8 b
    g4 g f8 f r4
    b g f8 f r4
    r8 f f g r d d es
