...
dclivSopranoNotes = {
	\relative c' {
		\clef treble
		\key c \major \time 4/4 \autoBeamOff \tempoDCLIV
		\partial 8 \mvTr g'8\fE^\tuttiE g[( c]) e d d8. c16 c8 c16[( e])
		g4. g,8 g4 r8 e'
...
dclivSopranoLyrics = \lyricmode {
	Sub tu -- um prae -- si -- di -- um, prae --
	si -- di -- um con --
