...
DCCXCIIOrgano = {
  \relative c {
    ...
    g,8 g'\f g g g g
    fis fis fis fis h, h
    \key d \major \grace s8 e e e e g g
    a a a a cis, cis %125
    d4-\tutti r r
    r a cis
    d r r
    ...
    a' r a,
    d8 d' d a a fis
    d4 r r\fermata \bar "|." %229 finis
  }
}

DCCXCIIBassFigures = \figuremode {
  r2.
  <[6]>2 <2>4
  <6>2.
  <[6]>2 <2>4
  ...
  r
  <6 4\+>4 <7 5>2
  <9 4>4 \bo <[8] 3>4. \once \bassFigureExtendersOn \bc q8 %35
  <6 4\+>4 <7 5>2
  <9 4>8 <[8] 3> r2
  <5>8 <5\+> <6>2
  <6[!] 4>4 <[5] 3>2
  ...
  <\t>
  r2 <7 2>4
  \bo <8 [3]>2 \bassFigureExtendersOn <8 3>8 \bc <8 [3]> \bassFigureExtendersOff
  r2. %85
  r4 <\t> <[6]>
  <7> q2
  r2 <7>4
  ...
  q8 q \bassFigureExtendersOff <8 6> <5 [3]>4. %105
  <7 [5]>8 <8 6> <6 4>4 <5 [3]>
  r2.
  r2 <\t>4
  <6>2 <2>4
  ...
  <[7 _+]>
  r2 <5>4 %150
  <9 4>4. \once \bassFigureExtendersOn q8 <6>4
  <_+>2.
  r
  <6\\>2 <6>4
  <6 5> <_+> <5> %155
  ...
  r4 q2
  <[9 7]>4 <6 4> <7 [5]>
  <9 4> \bo <[8] 3>4. \once \bassFigureExtendersOn \bc q8 %180
  <6>2.
  r4 q2
  <[9 7] _+>4 <6 4> <7 [_+]>
  <9 4> <[8] 3>2
