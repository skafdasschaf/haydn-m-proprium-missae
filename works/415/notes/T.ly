...
CDXVaTenore = {
  \relative c' {
    ...
    e2 e,4
    r ais ais
    h8([ cis)] h([ cis)] dis([ e)] %105
    dis fis fis4( e8) e
    dis4 \mvTr fis,\fE^\tutti fis
    e fis fis
    e8. e16 fis4 r
    r \mvTr g2~\pE^\solo %110
    g4 g h
    c2 c4
    g( fis) dis'
    e8([ dis)] e4 \mvTr g,8\fE^\tutti g
    h4 h h8 h %115
    a4 g r
    r \mvTr h2~\pE^\solo
    h4 g d!
