...
CDXVaAlto = {
  \relative c' {
    ...
    h( ais) ais
    r e e
    dis8([ e)] dis([ e)] fis([ g)] %105
    fis a a4( g8) g
    fis4 \mvTr dis\fE^\tutti dis
    e dis dis
    e8. e16^\critnote dis4 r
    r \mvTr h2~\pE^\solo %110
    h4 e g
    g( fis) a
    e( dis) a'
    g8([ fis)] e4 \mvTr h8\fE^\tutti h
    fis'4 e e8 e %115
    fis4 h, r
    r \mvTr d!2~\pE^\solo
    d4 h' h
