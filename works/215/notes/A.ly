...
ccxvAltoNotes = {
	\relative c' {
		...
		gis e e4. e8
		e4. e8 e4 r %25
		e4. e8 e gis16 gis gis8 h
		h8. a16 a4 a8 a a a
		fis4 fis8 e fis8. h,16 h4
		dis4. fis8 e4 e
		e( dis8.) e16 e4 r %30
		e4. e8 e e g g
		g4 g d4. d8
		...
		\appoggiatura fis g4 fis d4. d8
		d d fis g d4 d %160
		g4. g8 g g g^\critnote g
		g4 g g4. g8
		fis! fis fis fis g4 g8([ fis)]
		e4. e8 d([ fis)] g4
		g( fis8.) fis16 g4 r %165
		g r g r
		g4.\p g8 \appoggiatura g fis4 fis
		g4. g8 \appoggiatura g fis4^\critnote fis
		g4. g8 fis([ d)] d4
		g\f r e r8 d %170
		d g g fis g4 r
		g4. e8 fis4 fis
		...
		fis4. fis8 g4 g8 g
		g4 fis g8 d16 d d4
		d8 g a fis g d16 d d4 %180
		d8 g a fis g g a fis
		g4 r r2\fermata \bar "|." %182 finis
	}
}

ccxvAltoLyrics = \lyricmode {
	Lau -- da Si -- on Sal -- va --
	to -- rem, lau -- da
